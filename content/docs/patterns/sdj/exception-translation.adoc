---
title: Маппинг исключений на DataAccessException (в версиях до 4) (v1.0.0)
type: docs
weight: 500
---
...
[WARNING]
====
В Spring Data JDBC 4 DbActionExecutionException https://github.com/spring-projects/spring-data-relational/pull/1956[удалили] и маппинг более не актуален.
====
